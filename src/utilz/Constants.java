...
public class Constants {
	...
	public static class Projectiles{
		public static final int CANNON_BALL_DEFALUT_WIDTH = 15;
		public static final int CANNON_BALL_DEFALUT_HEIGHT = 15;

		public static final int CANNON_BALL_WIDTH = (int) (Game.SCALE * CANNON_BALL_DEFALUT_WIDTH);
		public static final int CANNON_BALL_HEIGHT = (int) (Game.SCALE * CANNON_BALL_DEFALUT_HEIGHT) ;
	...
	public static class ObjectConstants{
		...
		public static int GetSpriteAmount(int obj_Type) {
			switch(obj_Type) {
	...
	public static class UI{
		...
		public static class VolumesButtons{
