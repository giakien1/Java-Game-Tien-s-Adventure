...
public class Constants {
	...
	public static  class EnemyConstans{
		...
		public static final int CRAABY_DRAWOFFSET_X = (int)(26 * Game.SCALE);
		public static final int CRAABY_DRAWOFFSET_Y = (int)(9 * Game.SCALE);

		public static int GetSpriteAmout(int enemy_type, int enemy_state) {
			switch(enemy_type) {
				case CRABBY:
					switch(enemy_state) {
						case IDLE:
